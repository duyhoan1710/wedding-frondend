...
import * as fetcher from "@/lib/fetchers";
...
export default function Register(): JSX.Element {
  ...
  const { mutate: onSubmit, isPending } = useMutation({
    mutationFn: () => fetcher.register(getValues()),
    onSuccess: () => {
      router.push("/login");
    },
  ...
  return (
    <section className="flex h-full min-h-screen items-center justify-center bg-neutral-200 dark:bg-neutral-700">
      <div className="h-full max-w-[80%] lg:max-w-[66%]">
                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    ...
                    <div className="text-center">
                      <h3 className="mb-12 mt-1 pt-3 pb-1 text-2xl font-semibold italic">
                        Welcome,
                      </h3>
                    </div>
